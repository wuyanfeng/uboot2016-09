cmd_board/samsung/JZ2440/lowlevel_init.o := arm-linux-gcc -Wp,-MD,board/samsung/JZ2440/.lowlevel_init.o.d  -nostdinc -isystem /opt/FriendlyARM/toolschain/4.4.3/lib/gcc/arm-none-linux-gnueabi/4.4.3/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -D__ASSEMBLY__ -g -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv4t -D__LINUX_ARM_ARCH__=4   -c -o board/samsung/JZ2440/lowlevel_init.o board/samsung/JZ2440/lowlevel_init.S

source_board/samsung/JZ2440/lowlevel_init.o := board/samsung/JZ2440/lowlevel_init.S

deps_board/samsung/JZ2440/lowlevel_init.o := \
...
board/samsung/JZ2440/lowlevel_init.o: $(deps_board/samsung/JZ2440/lowlevel_init.o)
